...
import styles from "./CompanyWork.module.css"

const CompanyWorking = () => {
    const company=[
        {
            id:1,
            image1:"	https://d2q79iu7y748jz.cloudfront.net/s/_squarelogo/64x64/13b693b4dcc055d2344351b4c9a148e9",
            name1:"TCS",
            ratingone:3.8,
            statone:<StarIcon/>,
            noofreviewone:"3.1k reviews",
            image2:"	https://d2q79iu7y748jz.cloudfront.net/s/_squarelogo/64x64/937f45741cd71ec4372450a80ecf5ace",
            name2:"Infosys",
            ratingtwo:3.9,
            startwo:<StarIcon/>,
        ...
        {company.map((item)=>(
            <div className={styles.cardcontainerdiv}>
                <div className={styles.firstcompanyparentdiv}>
                    <div style={{boxShadow:'4px 4px 1px whitesmoke ' ,borderRadius:'8px',boxSizing:'border-box',marginRight:'15px'}}><img src={item.image1} className={styles.companylogo} width='40px' height={'40px'}/></div>
                    <div>
                    <div>{item.name1}</div>
                ...
                <div>Vs</div>
                <div className= {styles.firstcompanyparentdiv}>
                <div style={{boxShadow:'4px 4px 1px whitesmoke ' ,borderRadius:'8px',boxSizing:'border-box',marginRight:'15px'}}><img src={item.image2} className={styles.companylogo}/></div>
                    <div>
                    <div>{item.name2}</div>
                    <div className={styles.ratingone}>
